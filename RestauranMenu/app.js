const menu = [
  ...
  function createButtons(){ //buttonları oluşturmak için kullandığımız fonksiyon
    let allButtons= //tüm butonları html kodları ile yazıyoruz
    ` 
  ...
  function createFoods(food) //yemekleri oluşturmak için yazdığım fonksiyon
  { 
